...
/*   Updated: 2023/02/02 16:19:25 by sleleu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//---------------------------------------------------------------------------------------		
		                                       ...
		                                       typename ft::iterator_traits<Iterator>::reference >*/
	{
		...
		template< class U >
		reverse_iterator( const ft::reverse_iterator<U>& other );
...
//-------------------------- MEMBER FUNCTIONS -------------------------------------------
		...
		reverse_iterator operator-( difference_type n ) { return (reverse_iterator(current + n)); }
		/* unspecified */ operator[]( difference_type n ) const { return (current[-n-1]); }
//---------------------------------------------------------------------------------------
